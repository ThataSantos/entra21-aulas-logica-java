package br.com.entra21.aula13.aulapratica.vetores;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 5:
				percorrerVetorInicializadoCrescenteDecrescente();// chamada de metododo
	...
	private static void exibirTamnhoVetores() {
